...
public class StudentService {
    ...
    public Students addStudent(Students student)
    {
        ...
        {
            throw new EmptyInputFieldsException("601","Name field is empty");
        }
        if(student.getId()==0)
        {
            throw new EmptyInputFieldsException("601","Id field is empty");
        }
        if(student.getAge()==0)
        {
            throw new EmptyInputFieldsException("601","Age field is empty");
        }
